/*
 * Document: lớp DAO cho giao diện quản lý chuyên đề
...
public class ChuyenDeDAO {
    ...
    public int  insert(ChuyenDe model) {
    ...
    public int update(ChuyenDe model) {
    ...
    public int  delete(String MaCD) {
        ...
        return JdbcHelper.executeUpdate(sql, MaCD);
    }
