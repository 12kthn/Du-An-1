...
EXEC SP_NhanVien NS002, N'Lê Văn Việt', 1, '1996/12/7',  '8793656767', '0937499390', 
	null, N'Bình Dương', null, N'Đại Học', 'HDLD160004', 'NT', 'NS', '2018/11/20', null, 2.5, 1, 'Insert'
--------------------------------------------------------------------------------------
EXEC SP_NhanVien NS003, N'Nguyễn Tiến Dũng', 1, '1997/01/21',  '786566367', '0925415678', 
	null, N'Đồng Nai', null, N'Đại Học', 'HDLD180007', 'NV', 'NS', '2018/11/20', null, 2, 1, 'Insert'
--------------------------------------------------------------------------------------
EXEC SP_NhanVien NS004, N'Nguyễn Tiến Đạt', 1, '1996/02/20',  '8032537419', '0126478863', 
	null, N'Quận 2', null, N'Đại Học', 'HDLD180008', 'NV', 'NS', '2018/11/20', null, 2, 1, 'Insert'
--------------------------------------------------------------------------------------
EXEC SP_NhanVien NS005, N'Nguyễn Thị Huệ', 0, '1996/03/20',  '7745633689', '0125345345', 
	null, N'Quận 9', null, N'Đại Học', 'HDLD160005', 'NT', 'NS', '2018/11/20', null, 2.5, 1, 'Insert'
--------------------------------------------------------------------------------------
EXEC SP_NhanVien NS006, N'Nguyễn Cẩm Ly', 0, '1995/05/15',  '9893433245', '098654788', 
	null, N'Gò Vấp', null, N'Đại Học', 'HDLD180009', 'NV', 'NS', '2018/11/20', null, 2, 1, 'Insert'
--------------------------------------------------------------------------------------
EXEC SP_NhanVien NS007, N'Lê Thị Ngọc Trinh', 0, '1994/08/01',  '8863412299', '098698698', 
	null, N'Bình Dương', null, N'Đại Học', 'HDLD180010', 'NV', 'NS', '2018/11/20', null, 2, 1, 'Insert'
--------------------------------------------------------------------------------------
EXEC SP_NhanVien NS008, N'Lê Thị Ngọc', 0, '1996/08/08',  '7878939890', '0125656454', 
	null, N'Bình Dương', null, N'Đại Học', 'HDLD160006', 'NT', 'NS', '2018/11/20', null, 2.5, 1, 'Insert'
--------------------------------------------------------------------------------------
EXEC SP_NhanVien NS009, N'Trần Văn Công', 1, '1996/07/08',  '8388438569', '0126654545', 
	null, N'Thủ Đức', null, N'Đại Học', 'HDLD180011', 'NV', 'NS', '2018/11/20', null, 2, 1, 'Insert'
--------------------------------------------------------------------------------------
EXEC SP_NhanVien NS010, N'Trần Đức Nam', 1, '1995/10/21',  '7673756478', '0126686996', 
	null, N'Thủ Đức', null, N'Đại Học', 'HDLD180012', 'NV', 'NS', '2018/11/20', null, 2, 1, 'Insert'
GO
...
EXEC SP_NhanVien KT001, N'Đào Hồng Sơn', 1, '1994/11/5',  '5613253164', '0921587694', 
	null, N'Gò Vấp', null, N'Cao đẳng', 'HDLD150003', 'TP', 'KT', '2018/11/20', null, 3, 1, 'Insert'
--------------------------------------------------------------------------------------
EXEC SP_NhanVien KT002, N'Phan Lê Khải', 1, '1994/11/5',  '7778379866', '0986777650', 
	null, N'Đồng Nai', null, N'Cao đẳng', 'HDLD160007', 'NT', 'KT', '2018/11/20', null, 2.5, 1, 'Insert'
--------------------------------------------------------------------------------------
...
EXEC SP_NhanVien KT004, N'Nguyễn Văn Lâm', 1, '1998/09/12',  '7657736897', '0930909364', 
	null, N'Long An', null, N'Đại Học', 'HDLD180014', 'NV', 'KT', '2018/11/20', null, 2, 1, 'Insert'
--------------------------------------------------------------------------------------
...
EXEC SP_NhanVien MK002, N'Nguyễn Văn Biển', 1, '1995/1/9',  '7634332345', '0126998562', 
	null, N'Tân Phú', null, N'Cao đẳng', 'HDLD160010', 'NT', 'MK', '2018/11/20', null, 2.5, 1, 'Insert'
--------------------------------------------------------------------------------------
EXEC SP_NhanVien MK003, N'Nguyễn Đức Nam', 1, '1995/10/8',  '5546536543', '0902322321', 
	null, N'Tân Bình', null, N'Đại Học', 'HDLD180019', 'NV', 'MK', '2018/11/20', null, 2, 1, 'Insert'
--------------------------------------------------------------------------------------
...
EXEC SP_NhanVien MK007, N'Nguyễn Văn Kiên', 1, '1996/9/10',  '7446563778', '0126666731', 
	null, N'Quận 3', null, N'Đại Học', 'HDLD180022', 'NV', 'MK', '2018/11/20', null, 2, 1, 'Insert'
--------------------------------------------------------------------3------------------
...
EXEC SP_NhanVien IT003, N'Đỗ Đại Dương', 1, '1995/12/12',  '6557844354', '0937790086', 
	null, N'Bình Thạnh', null, N'Cao đẳng', 'HDLD180001', 'NV', 'IT', '2018/11/20', null, 2, 1, 'Insert'
--------------------------------------------------------------------------------------
...
EXEC SP_NhanVien IT006, N'Nguyễn Đức Tùng', 1, '1997/05/22',  '7441413670', '0126478869', 
	null, N'Quận 9', null, N'Cao đẳng', 'HDLD180003', 'NV', 'IT', '2018/11/20', null, 2, 1, 'Insert'
--------------------------------------------------------------------------------------
EXEC SP_NhanVien IT008, N'Lê Văn Phú', 1, '1996/05/22',  '6643441180', '0126478869', 
	null, N'Quận 9', null, N'Cao đẳng', 'HDLD180004', 'NV', 'IT', '2018/11/20', null, 2, 1, 'Insert'
--------------------------------------------------------------------------------------
